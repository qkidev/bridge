...
func (_Token *TokenTransactor) ChangeUser(opts *bind.TransactOpts, new_operator common.Address, new_pauser common.Address) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "changeUser", new_operator, new_pauser)
}

// ChangeUser is a paid mutator transaction binding the contract method 0x8e50817a.
//
// Solidity: function changeUser(address new_operator, address new_pauser) returns()
func (_Token *TokenSession) ChangeUser(new_operator common.Address, new_pauser common.Address) (*types.Transaction, error) {
	return _Token.Contract.ChangeUser(&_Token.TransactOpts, new_operator, new_pauser)
}

// ChangeUser is a paid mutator transaction binding the contract method 0x8e50817a.
//
// Solidity: function changeUser(address new_operator, address new_pauser) returns()
func (_Token *TokenTransactorSession) ChangeUser(new_operator common.Address, new_pauser common.Address) (*types.Transaction, error) {
	return _Token.Contract.ChangeUser(&_Token.TransactOpts, new_operator, new_pauser)
}
